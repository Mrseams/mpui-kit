...
import { useLocale, useMpKit, useT } from "@/components/mpkit/mpkit-provider"
import { useCountdown } from "@/hooks/mpkit/use-countdown"
import { copyToClipboard } from "@/lib/mpkit/clipboard"
import { announcementBucket, formatCountdown } from "@/lib/mpkit/countdown"
import type { CountryConfig, Locale } from "@/lib/mpkit/countries/types"
import { dialHref } from "@/lib/mpkit/dial"
import type { Translator } from "@/lib/mpkit/i18n"
import { formatInternational, validatePhone } from "@/lib/mpkit/phone"
...
export interface UssdPromptProps extends Omit<ComponentProps<"section">, "children"> {
  ...
  onExpire?: () => void
  /** Only used to format `phone`. Defaults to the one in `MpKitProvider`. */
