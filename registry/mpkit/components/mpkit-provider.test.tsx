...
import {
  ...
  useLocale,
  useT,
  type MpKitProviderProps,
} from "@/components/mpkit/mpkit-provider"
...
function withProvider(props: Omit<MpKitProviderProps, "children">) {
  return function Wrapper({ children }: { children: ReactNode }) {
    return <MpKitProvider {...props}>{children}</MpKitProvider>
  }
}
